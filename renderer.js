...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('renderer.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('renderer.wasm', import.meta.url).href;
}
...
var _InitRendererFromMemory = Module['_InitRendererFromMemory'] = createExportWrapper('InitRendererFromMemory', 2);
var _RenderFrame = Module['_RenderFrame'] = createExportWrapper('RenderFrame', 5);
var _ShutdownRenderer = Module['_ShutdownRenderer'] = createExportWrapper('ShutdownRenderer', 0);
